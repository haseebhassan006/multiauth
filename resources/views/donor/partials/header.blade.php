...
<a class="navbar-brand" href="index.html"><img src="{{asset('assets/donor/images/logo.svg')}}" alt=""></a>
...
<a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid" src="{{asset('assets/donor/images/user/s4.png')}}"></a>
...
<div class="dropdown-user-details-email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="afc6cec2c0dccec7cec1efc8c2cec6c381ccc0c2">[email&#160;protected]</a></div>
</div>
</h6>
...
<li class="nav-item">
<a class="nav-link" href="about.html">Request</a>
</li>
<li class="nav-item">
...
<a class="dropdown-item" href="dashboard.html">Create Message</a>
<a class="dropdown-item" href="orders.html">Inbox</a>
<a class="dropdown-item" href="gigs.html">Outbox</a>
</div>
</li>
<li class="nav-item">
